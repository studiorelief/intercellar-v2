...
(() => {
  ...
  // src/utils/ic/home/gsap.ts
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  function parallaxHpNewsletter() {
  ...
  function parallaxHpHero() {
    ...
    if (!videoHero1 || !videoHero2 || !videoHero3 || !section)
      return;
  ...
  // src/utils/ic/home/swiper.ts
  function swiperHpHero() {
  ...
  // src/utils/script/modalviewer.ts
  ...
  function resetGlbCoin() {
    const modelViewer = document.querySelector("#reveal-coin");
    if (!modelViewer)
      return;
